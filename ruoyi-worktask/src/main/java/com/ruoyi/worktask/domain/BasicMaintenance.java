 ...
 * @date 2019-06-13
 */
public class BasicMaintenance extends BaseEntity
{
	...
	/** 考核指标 */
	@Excel(name = "考核指标", prompt = "考核指标")
	private String remark1;
	/** 存在问题及计划 */
	@Excel(name = "存在问题及计划", prompt = "存在问题及计划")
	private String taskContent;
	/** 牵头部门 */
	@Excel(name = "牵头部门", prompt = "牵头部门")
	private String remark2;
	/** 配合部门 */
	@Excel(name = "配合部门", prompt = "配合部门")
