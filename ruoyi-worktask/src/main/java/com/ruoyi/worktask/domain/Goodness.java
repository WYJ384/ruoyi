 ...
 * @date 2019-06-13
 */
public class Goodness extends BaseEntity
{
	...
	/** 分项 */
	@Excel(name = "分项", prompt = "分项")
	private String taskTitle;
	/** 具体问题 */
	@Excel(name = "具体问题", prompt = "具体问题")
	private String remark5;
	/** 目标 */
	@Excel(name = "目标", prompt = "目标")
	private String remark1;
	/** 措施及建议 */
	@Excel(name = "措施及建议", prompt = "措施及建议")
	private String taskContent;
	/** 责任部门 */
	@Excel(name = "责任部门", prompt = "责任部门")
