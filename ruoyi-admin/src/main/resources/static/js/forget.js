...
var noPhoneNum=document.getElementById('phone');
var otp=document.getElementById('verifyNo');
var getcodeBtn=document.getElementById('getcode');
var loginBtn1=document.getElementById('aui-btn-reg1');
var country=[
    ' ',
];
...
function submitHandler() {
    if ($.validate.form()) {
        ...
        var config = {
            ...
            type: "post",
            dataType: "json",
            data: {phone:$('#phone').val(),verifyNo:$("#verifyNo").val()},
            beforeSend: function () {
                $.modal.loading("正在处理中，请稍后...");
            },
            success: function (result) {
