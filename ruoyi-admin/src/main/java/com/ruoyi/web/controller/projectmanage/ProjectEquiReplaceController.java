...
public class ProjectEquiReplaceController extends BaseController
{
    ...
    {
        projectEquiReplace.setId(UUID.randomUUID().toString().replaceAll("-",""));
        projectEquiReplace.setCreateDate(new Date());
        projectEquiReplace.setCreateBy(ShiroUtils.getUserId()+"");
    ...
    {
        projectEquiReplace.setUpdateDate(new Date());
        projectEquiReplace.setUpdateBy(ShiroUtils.getUserId()+"");
